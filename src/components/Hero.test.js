...
describe("Hero terminal", () => {
  beforeEach(() => {
    ...
    document.body.innerHTML =
      '<section id="projects"></section><section id="skills"></section><footer></footer>';
  ...
  it("enters interactive mode after skip and shows the help hint", () => {
    ...
    expect(
      container.querySelector('input[aria-label="Terminal command input"]'),
    ).not.toBeNull();
  ...
  it("scrolls to the projects section when projects is entered", () => {
    ...
    expect(container.textContent).toContain(
      "Projects loaded. Scrolling to portfolio section...",
    );
  ...
  it("opens the GitHub profile when github is entered", () => {
    ...
    expect(window.open).toHaveBeenCalledWith(
      "https://github.com/le-lel190",
      "_blank",
      "noopener,noreferrer",
    );
    expect(container.textContent).toContain(
      "Opening GitHub: https://github.com/le-lel190",
    );
